...
registerBlockType( 'tss/player-stats-table', {
	edit( { attributes, setAttributes } ) {
		...
		return (
			<>
				<InspectorControls>
					<PanelBody title={ __( 'Player Stats Table Settings', 'tss' ) }>
						<SelectControl
							label={ __( 'Season', 'tss' ) }
				...
				<ServerSideRender block="tss/player-stats-table" attributes={ attributes } />
			</>
		);
	},
	save() {
